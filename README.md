...
- Timestamp: `2022-06-21 13:35`
- Build ID: `73bbaec9-0a92-4cdd-8eab-74edfb4850a2`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/73bbaec9-0a92-4cdd-8eab-74edfb4850a2.git
$ cd 73bbaec9-0a92-4cdd-8eab-74edfb4850a2
```
